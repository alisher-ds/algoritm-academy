        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3.5 sm:gap-4">
          {ECOSYSTEM_DATA.school.dailySchedule.map((item, idx) => {
            ...
            return (
              <div
                key={idx}
                className="group p-4 sm:p-5 rounded-2xl bg-white border border-slate-200/90 shadow-xs hover:border-brand-500 hover:shadow-md transition-all duration-200 text-left flex flex-col justify-between"
              >
                <div>
