    ...
    <section className="bg-white py-24 sm:py-32 text-slate-900 border-b border-slate-200/80" id="sharoitlar">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          {ECOSYSTEM_DATA.school.features.map((feat, idx) => (
            <ScrollReveal
              key={feat.id}
              variant="fade-up"
              delay={idx * 100}
            ...
            >
              <div
                className="p-8 rounded-3xl bg-slate-50 border border-slate-200/80 hover:border-brand-400 hover:bg-white hover:shadow-lg transition-all duration-300 group flex flex-col justify-between text-left w-full"
              >
                <div>
