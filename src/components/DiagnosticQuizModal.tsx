...
function recommend(interest: string, stage: Stage | "", goal: string): QuizResult {
  ...
  if (interest === "sat") {
    ...
    return base(
      "SAT Digital & 100% Xalqaro Grant",
      "AQSH va xorijiy nufuzli universitetlarga 100% grant yutish uchun SAT Math va Reading & Writing intensiv kursi.",
  ...
  if (interest === "math") {
    ...
    return base(
      ...
      "Milliy sertifikat A+ va OTMlarga 100% davlat grantiga kirish uchun chuqurlashtirilgan mualliflik kursi.",
      stage === "abituriyent"
