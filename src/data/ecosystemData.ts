...
export const ECOSYSTEM_DATA = {
  ...
  school: {
    ...
    programs: [
      ...
      },
      {
        ...
        description: "Dunyoning top universitetlariga SAT 1500+ natijalari, 10-sinfdayoq OTMga 189 maksimal ball va Matematika Milliy A+ sertifikatiga repetitorsiz chuqurlashtirilgan tayyorgarlik.",
        focus: [
          "SAT 1500+ natijasi bilan dunyo oliygohlariga nufuzli grantlar",
  ...
  courses: [
    ...
    },
    {
      ...
      description: "AQSH va xorijiy nufuzli universitetlarga to'liq grant yutishga yo'naltirilgan SAT Math va Reading & Writing intensiv kursi.",
      duration: "5 oy",
      weeklyHours: "Haftada 3 kun · 2.5 soat",
      level: "Intermediate - Advanced",
      targetAudience: "8-11 sinf o'quvchilari va talabalar",
      features: [
        "SAT 1500+ ballga yo'naltirilgan intensiv o'quv rejasi",
    ...
    },
    {
      ...
      description: "5-11 sinflar va abituriyentlar uchun mualliflik metodikasi. Milliy sertifikat (A+) va DTM imtihonlariga tizimli chuqurlashtirilgan tayyorgarlik.",
      duration: "9 oy",
      weeklyHours: "Haftada 3 kun · 2 soat",
      level: "5-11 Sinflar & Abituriyentlar",
      targetAudience: "Maktab o'quvchilari va abituriyentlar",
      features: [
        "Milliy sertifikat (A+) talablariga to'liq mos intensiv dastur",
  ...
  achievements: [
    ...
    },
    {
      ...
      detail: "Maktab o'quvchisi: darslar davomida 5 oylik tayyorgarlik natijasida SAT 1430 va IELTS 6.5 ball to'plab, to'liq davlat grantini qo'lga kiritdi.",
      year: "2026",
      yearGroup: "2026",
